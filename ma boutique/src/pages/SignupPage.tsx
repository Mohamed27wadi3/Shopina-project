...
export function SignupPage() {
  ...
  const handleGitHubSignup = async () => {
    ...
    try {
      // For now, show informative message
      toast.info("Inscription GitHub bientôt disponible", {
        description: "Cette fonctionnalité nécessite la configuration des credentials OAuth dans l'admin Django"
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0077FF]/5 via-[#5AC8FA]/5 to-white dark:from-[#0A0A0A] dark:via-[#1A1A1A] dark:to-[#0A0A0A] flex flex-col">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-[#0A1A2F]/60">
              Commencez votre aventure e-commerce dès maintenant
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#0A1A2F]/40" />
                <Input
                  id="name"
                  type="text"
                  ...
                  className="pl-12 h-12 rounded-xl border-2 border-gray-200 focus:border-[#0077FF]"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#0A1A2F]/40" />
                <Input
                  id="email"
                  type="email"
            ...
            {/* Password */}
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[#0A1A2F]">
                Mot de passe
              </Label>
              <div className="relative">
            ...
            {/* Confirm Password */}
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-[#0A1A2F]">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 mt-1 rounded border-gray-300 text-[#0077FF] focus:ring-[#0077FF]" required />
              <span className="text-sm text-[#0A1A2F]/70">
                J'accepte les{" "}
                <Link to="#" className="text-[#0077FF] hover:underline">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-[#0A1A2F]/60">Ou s'inscrire avec</span>
              </div>
            </div>
          ...
          <p className="text-center mt-6 text-[#0A1A2F]/60">
            ...
            <Link to="/login" className="text-[#0077FF] hover:underline" style={{ fontWeight: '600' }}>
              Se connecter
            </Link>
          </p>
        </div>
