...
import type { TemplateConfig } from '../types/template-extended';
          ...
          <div className={`mx-auto bg-white shadow-2xl transition-all duration-300 ${getDeviceWidth()}`}>
            <div className="text-gray-900 bg-white font-sans">
              ...
              {template.sections.find((s) => s.type === 'hero' && s.enabled) && (
                <section className="py-16 px-6 bg-gradient-to-br from-blue-50 to-purple-50">
                  <div className="container mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl mb-4 font-serif font-semibold">
                      New Collection
                    </h1>
                    <p className="text-lg mb-8 opacity-80">Discover our latest arrivals</p>
              ...
              {template.sections.find((s) => s.type === 'products' && s.enabled) && (
                <section className="py-12 px-6">
                  <div className="container mx-auto">
                    <h2 className="text-3xl mb-8 font-serif font-semibold">
                      Featured Products
                    </h2>
                    ...
                    >
                      {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="group cursor-pointer rounded-lg">
                          <div className="aspect-square bg-gray-100 mb-3 overflow-hidden rounded-lg shadow-sm">
              ...
              {template.sections.find((s) => s.type === 'newsletter' && s.enabled) && (
                <section className="py-12 px-6 bg-blue-50">
                  <div className="container mx-auto text-center max-w-2xl">
                    ...
                    <p className="mb-6 opacity-80">Get the latest updates and exclusive offers</p>
                    <div className="flex gap-2 max-w-md mx-auto">
                      ...
                      />
                      <button className="px-6 py-2 text-white font-medium bg-blue-600 rounded-md">
                        Subscribe
                      </button>
                    </div>
                  </div>
              ...
              <footer className="py-8 px-6 border-t border-gray-200">
                <div className="container mx-auto">
                  <div className={`grid gap-8 ${device === 'mobile' ? 'grid-cols-1' : 'grid-cols-4'}`}>
                    <div>
                      <h3 className="font-semibold mb-3 font-serif">
                        About
                      </h3>
